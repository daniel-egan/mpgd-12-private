//This script was made using this tutorial: https://youtu.be/rJqP5EesxLk?si=CMstgPC0u9ets30Y (default moving around)
//This script was made using this tutorial: https://www.youtube.com/watch?v=wDmXmgvzueI (wallrunning)
//This script was made using this tutorial: https://www.youtube.com/watch?v=gNt9wBOrQO4 (wallrunning)
//This script was made using this tutorial: https://www.youtube.com/watch?v=Xgh4v1w5DxU (grappling)
//This script was made using this tutorial: https://www.youtube.com/watch?v=TYzZsBl3OI0 (grappling)
//This script was made using this tutorial: https://www.youtube.com/watch?v=QRYGrCWumFw&t=515s (dashing)

//Any mention of "SD" refers to SuperDash
//All uses of ChatGPT have been shown with a "START OF GENERATED BY CHATGPT" and "END OF GENERATED BY CHATGPT" comment
...
public class PlayerMotor : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Handle SuperDash Loss and Grapple disable when grounded
        if (isGrounded)
        {
        ...
        //Handle UI refresh for SuperDash buildup/regular refresh
    ...
    private IEnumerator PerformDash()
    {
        canDash = false;
        isDashing = true;
        dashedBeforeGrapple = true; //Enable for potential SuperDash buildup
    ...
    private IEnumerator PerformSuperDash()
    {
        ...
        //reset SuperDash buildup values to 0
    ...
    void UpdateDashCooldownUI(bool forceUpdate = false)
    {
        ...
        //forceUpdate indicates that SuperDash buildup has occurred
        if (forceUpdate)
        {
            ...
            //Incrementing SuperDash buildup
            if (canSuperCount)
            {
    ...
    void StopGrapple()
    {
        ...
        if (dashedBeforeGrapple) //Ensure a dash occurred before the grapple
        {
            ...
            //Increment SuperDash counter and update the UI
            instantCooldownCount++;
            lastCountTime = Time.time;
        ...
        //START OF GENERATED BY CHATGPT
        //Snap player to ground after grappling
        if (!isGrounded)
        {
            Ray groundRay = new Ray(transform.position, Vector3.down);
            if (Physics.Raycast(groundRay, out RaycastHit hit, 2f, grappleLayer))
            {
                controller.Move(Vector3.down * (hit.distance - 0.1f)); //adjustment to ground level
            }
        }
        //END OF GENERATED BY CHATGPT
